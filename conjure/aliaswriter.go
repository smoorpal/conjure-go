...
func astForAlias(aliasDefinition spec.AliasDefinition, info types.PkgInfo) ([]astgen.ASTDecl, error) {
	...
	jsonMethods, err := jsonencoding.AliasTypeUnmarshalMethods(aliasReceiverName, aliasDefinition.TypeName.Name, aliasDefinition.Alias, info)
	if err != nil {
		return nil, err
	}
...
//        return a.String()
//    }
func astForAliasString(aliasDefinition spec.AliasDefinition, aliasGoType expression.Type) astgen.ASTDecl {
